...
we care about, remaps their ids to stable local ids, and emits:
  - epg.xml      (merged XMLTV guide for all 7 known channels)
...
CHANNEL_MAP = {
    ...
    "C6.1.151.ersatztv.org":  ("whiplashbiwi",     "WHIPLASH BIWI",     "whiplash", "biwi"),
}
...
LOGOS = {
    ...
    "whiplashbiwi":     "https://whiplash.cc/assets/img/channels/whiplash.png",  # TODO: swap for real biwi logo if whiplash.cc publishes one
}
