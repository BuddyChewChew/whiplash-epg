...
CHANNEL_MAP = {
    ...
    # biwi intentionally omitted here: it has no entry in wl.xml/win.xml yet,
    # so there's no EPG data to map. It's still in STREAM_URLS/LOGOS/M3U below
    # so the channel plays; epg.xml just won't have programme info for it.
}
...
LOGOS = {
    ...
    "whiplashbiwi":      "https://whiplash.cc/assets/img/channels/whiplash.png",  # TODO: confirm real biwi logo path
}
